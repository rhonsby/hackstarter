json.cache! ['company', company.updated_at, company.amount_raised, company.days_left, company.sector_name, company.investors.length, company.updates.length, company.comments.length] do
